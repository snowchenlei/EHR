        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankOfDeposit = table.Column<string>(type: "nvarchar(125)", maxLength: 125, nullable: true),
                    ...
                    Constellation = table.Column<int>(type: "int", nullable: false),
                    BloodType = table.Column<int>(type: "int", nullable: false),
                    InServiceStatus = table.Column<int>(type: "int", nullable: false),
                    ViolationOfLawOrDiscipline = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    MajorMedicalHistory = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    TimeOfDimission = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CoverImageMediaId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IdCardPhotoPositive = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    IdCardPhotoBack = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModificationTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifierId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SnowMediaDescriptors", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppContract", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppContract_AppEmployee_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEducationExperience", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppEducationExperience_AppEmployee_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "AppEmployee",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppEmergencyContact", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppEmergencyContact_AppEmployee_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "AppEmployee",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppSalary", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppSalary_AppEmployee_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "AppEmployee",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppWorkExperience", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppWorkExperience_AppEmployee_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "AppEmployee",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppContractAnnex", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppContractAnnex_AppContract_ContractId",
                        column: x => x.ContractId,
                        principalTable: "AppContract",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppContract_EmployeeId",
                table: "AppContract",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_AppContractAnnex_ContractId",
                table: "AppContractAnnex",
                column: "ContractId");

            migrationBuilder.CreateIndex(
                name: "IX_AppEducationExperience_EmployeeId",
                table: "AppEducationExperience",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_AppEmergencyContact_EmployeeId",
                table: "AppEmergencyContact",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_AppSalary_EmployeeId",
                table: "AppSalary",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_AppWorkExperience_EmployeeId",
                table: "AppWorkExperience",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SnowMediaDescriptors_Hash",
                table: "SnowMediaDescriptors",
                column: "Hash");

            migrationBuilder.CreateIndex(
                name: "IX_SnowMediaDescriptors_Name",
                table: "SnowMediaDescriptors",
                column: "Name");
        }
