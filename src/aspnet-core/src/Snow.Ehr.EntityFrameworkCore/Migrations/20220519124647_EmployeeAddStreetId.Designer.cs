...
namespace Snow.Ehr.Migrations
{
    ...
    [Migration("20220519124647_EmployeeAddStreetId")]
    partial class EmployeeAddStreetId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Snow.DictionaryManagement.DictionaryTypeManagement.DictionaryType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("SnowDictionaryTypes", (string)null);
                });

            modelBuilder.Entity("Snow.DictionaryManagement.DictionaryValueManagement.DictionaryValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SnowDictionaryValues", (string)null);
                });

            modelBuilder.Entity("Snow.Ehr.EmployeeManagement.ContractAnnexes.ContractAnnex", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppContractAnnex", (string)null);
                });

            modelBuilder.Entity("Snow.Ehr.EmployeeManagement.Contracts.Contract", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppContract", (string)null);
                });

            modelBuilder.Entity("Snow.Ehr.EmployeeManagement.EducationExperiences.EducationExperience", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppEducationExperience", (string)null);
                });

            modelBuilder.Entity("Snow.Ehr.EmployeeManagement.EmergencyContacts.EmergencyContact", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppEmergencyContact", (string)null);
                });

            modelBuilder.Entity("Snow.Ehr.EmployeeManagement.Employees.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("IdCardPhotoBack")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("IdCardPhotoPositive")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("InServiceStatus")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("MajorMedicalHistory")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.Property<string>("ViolationOfLawOrDiscipline")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
            ...
            modelBuilder.Entity("Snow.Ehr.EmployeeManagement.Salaries.Salary", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("SocialInsuranceProportion")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("AppSalary", (string)null);
                });

            modelBuilder.Entity("Snow.Ehr.EmployeeManagement.WorkExperiences.WorkExperience", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppWorkExperience", (string)null);
                });

            modelBuilder.Entity("Snow.Media.MediaDescriptors.MediaDescriptor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SnowMediaDescriptors", (string)null);
                });

            modelBuilder.Entity("Snow.MenuManagement.Menus.Menu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("SnowMenu", (string)null);
                });
            ...
            modelBuilder.Entity("Snow.Ehr.EmployeeManagement.ContractAnnexes.ContractAnnex", b =>
                {
                    b.HasOne("Snow.Ehr.EmployeeManagement.Contracts.Contract", "Contract")
            ...
            modelBuilder.Entity("Snow.Ehr.EmployeeManagement.Contracts.Contract", b =>
                {
                    b.HasOne("Snow.Ehr.EmployeeManagement.Employees.Employee", "Employee")
                        .WithMany()
            ...
            modelBuilder.Entity("Snow.Ehr.EmployeeManagement.EmergencyContacts.EmergencyContact", b =>
                {
                    b.HasOne("Snow.Ehr.EmployeeManagement.Employees.Employee", null)
            ...
            modelBuilder.Entity("Snow.MenuManagement.Menus.Menu", b =>
                {
                    b.HasOne("Snow.MenuManagement.Menus.Menu", "Parent")
                        .WithMany()
