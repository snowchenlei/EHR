...
namespace Snow.Ehr.EmployeeManagement.EducationExperiences
{
    ...
    /// 教育经历管理
    /// </summary>
    [Authorize(EhrPermissions.EducationExperiences.Default)]
    public class EducationExperienceAppService : EhrAppService, IEducationExperienceAppService
    {
        ...
        /// <returns></returns>
        [Authorize(EhrPermissions.EducationExperiences.Create)]
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [Authorize(EhrPermissions.EducationExperiences.Update)]
        ...
        /// <param name="educationExperienceId">主键</param>
        /// <returns></returns>
        [Authorize(EhrPermissions.EducationExperiences.Delete)]
