...
namespace Snow.Ehr.EmployeeManagement.Contracts
{
    ...
    /// 合同管理
    /// </summary>
    [Authorize(EhrPermissions.Contracts.Default)]
    public class ContractAppService : EhrAppService, IContractAppService
    {
        ...
        /// <returns></returns>
        [Authorize(EhrPermissions.Contracts.Create)]
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [Authorize(EhrPermissions.Contracts.Update)]
        ...
        /// <param name="contractId">主键</param>
        /// <returns></returns>
        [Authorize(EhrPermissions.Contracts.Delete)]
