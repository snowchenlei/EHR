...
namespace Snow.Ehr.EmployeeManagement.Employees
{
    ...
    /// 员工管理
    /// </summary>
    [Authorize(EhrPermissions.Employees.Default)]
    public class EmployeeAppService : EhrAppService, IEmployeeAppService
    {
        ...
        /// <returns></returns>
        [Authorize(EhrPermissions.Employees.Create)]
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [Authorize(EhrPermissions.Employees.Update)]
        ...
        /// <param name="id">主键</param>
        /// <returns></returns>
        [Authorize(EhrPermissions.Employees.Delete)]
