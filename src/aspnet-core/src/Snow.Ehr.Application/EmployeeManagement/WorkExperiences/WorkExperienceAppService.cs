...
namespace Snow.Ehr.EmployeeManagement.WorkExperiences
{
    ...
    /// 工作经历管理
    /// </summary>
    [Authorize(EhrPermissions.WorkExperiences.Default)]
    public class WorkExperienceAppService : EhrAppService, IWorkExperienceAppService
    {
        ...
        /// <returns></returns>
        [Authorize(EhrPermissions.WorkExperiences.Create)]
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        [Authorize(EhrPermissions.WorkExperiences.Update)]
        ...
        /// <param name="workExperienceId">主键</param>
        /// <returns></returns>
        [Authorize(EhrPermissions.WorkExperiences.Delete)]
